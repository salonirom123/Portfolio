    ...
    <div>
      ...
      <div className='md:h-[958px] pt-[48px] pb-[48px] pl-[12px] pr-[12px]'>
        ...
        <div className='mb-[48px] pb-[16px] flex flex-col  items-center'>
           ...
           <h1 className='md:text-[40px] text-[29px] text-[#091E3E] font-bold mt-[-12px]  md:break-words'>If You Have Any Query, Feel</h1>
         ...
         <div className='mt-[48px] pl-[24px] pr-[24px] w-[447.99px] flex'>
          ...
          <div className='pl-[24px]'>
            ...
            <h4 className='text-[24px] text-[#06A3DA] font-bold'>salonirom254@gmail.com</h4>
          </div>
         </div>
         </div>
         <div className='mt-[48px] md:pl-[89px] pl-[24px] pr-[24px] w-[447.99px] flex'>
